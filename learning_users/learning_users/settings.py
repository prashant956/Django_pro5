...
SECRET_KEY = 'zoy_8oa@zxj0^j+g^+&p@up^c3(-&$e0gf1eb!-ln=56kk)#o+'
...
PASSWORD_HASHERS =[
    ...
    'django.contrib.auth.hashers.BCryptSHA256wordHasher',
    'django.contrib.auth.hashers.BCrptpasswordHasher',
